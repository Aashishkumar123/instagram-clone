    ...
    return(
        <>
            ...
            <div className="instagram-posts text-center mt-5 pt-4">
                <Link to="" style={{color:"var(--text)"}} data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                ...
                <Link to="" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Share your first photo</Link>
            </div>
            <Postmodal />
        </>
    )
