...
export const Followersmodal = ()=>{
    return(
        <>
            <div className="modal fade" id="followersModel" tabindex="-1" aria-labelledby="followersModelLabel" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                    <div className="modal-content followers-modal-content" style={{height:"50vh",overflow:"scroll"}}>
                        ...
                        <div className="followers-modal-body text-center">
                            <FollowersProfile img={profile} username="joslcbnd-36" name="joullsj" />
                            <FollowersProfile img={profile} username="joslcbnd-36" name="joullsj" />
                            <FollowersProfile img={profile} username="joslcbnd-36" name="joullsj" />
                            <FollowersProfile img={profile} username="joslcbnd-36" name="joullsj" />
                            <FollowersProfile img={profile} username="joslcbnd-36" name="joullsj" />
...
const FollowersProfile = ({img, username, name})=>{
    return(
        <>
